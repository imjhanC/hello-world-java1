pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                git branch: 'master', url: 'https://github.com/imjhanC/hello-world-java1.git'
            }
        }
        stage('Build') {
            steps {

                        powershell 'gradle clean build' // bat 'start gradlew build'
        ...
        stage('Test') {
            steps {
                        ...
                        powershell 'gradle test' //bat 'start gradlew test'
